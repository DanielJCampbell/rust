...
pub enum SyntaxExtension {
    ...
    //Represents a macro definition that failed to compile
    MalformedMacroTT,
}
...
pub struct ExtCtxt<'a> {
    ...
    // If true, expand will not abort if it has errors, and
    // span_fatal/span_bug calls generated by macro
    // compilation/expansion are demoted to span_err.
    pub allow_mac_err: bool,
}
...
impl<'a> ExtCtxt<'a> {
    ...
    // Returns false if the macro failed to compile.
    // This is only possible if allow_mac_err is true.
